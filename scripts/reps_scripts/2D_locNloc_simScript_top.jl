...
function evolve_system(flock, pars, n_t, κ_dist)

    ### COMPUTE RELATIVE DISTANCES
    CollectiveDynamics.calc_distance_matrix!(flock.pos, flock.Nij)
...
output_path = set_output_data_structure_lnl("NLOC_TOP_2D", N, κ, ω)
